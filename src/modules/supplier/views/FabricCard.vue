...
export default {
    ...
    computed: {
        chatss() {
            return this.$store.getters["supplier/getChatss"];
        },
        activeChat() {
            return this.$store.getters["supplier/getChat"];
        },
        gridSize() {
            switch (this.design) {
    ...
    methods: {
        showChat(chat) {
            return this.$store.dispatch("supplier/selectChat", chat);
        },
        hideChat() {
            return this.$store.dispatch("supplier/hideChat");
        }
    },
}
</script>
